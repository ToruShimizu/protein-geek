...
export type MakersQuery = {
  __typename?: "Query"
  makersCollection?: {
    __typename?: "makersConnection"
    edges: Array<{
      __typename?: "makersEdge"
      node: { __typename?: "makers"; id: any; name: string; src: string }
    }>
  } | null
}
          ...
          edges: Array<{
            ...
            node: {
              ...
              productsCollection?: {
                ...
                edges: Array<{
                  __typename?: "productsEdge"
                  node: { __typename?: "products"; id: any; capacity: string; price: string }
                }>
              } | null
            }
          }>
 ...
 * });
 */
export function useMakersQuery(
  baseOptions?: Apollo.QueryHookOptions<MakersQuery, MakersQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<MakersQuery, MakersQueryVariables>(MakersDocument, options)
}
export function useMakersLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<MakersQuery, MakersQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions }
 ...
 * });
 */
export function useMakerByIdQuery(
  baseOptions: Apollo.QueryHookOptions<MakerByIdQuery, MakerByIdQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<MakerByIdQuery, MakerByIdQueryVariables>(MakerByIdDocument, options)
}
export function useMakerByIdLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<MakerByIdQuery, MakerByIdQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions }
 ...
 * });
 */
export function useProteinByIdQuery(
  baseOptions: Apollo.QueryHookOptions<ProteinByIdQuery, ProteinByIdQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<ProteinByIdQuery, ProteinByIdQueryVariables>(ProteinByIdDocument, options)
}
export function useProteinByIdLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ProteinByIdQuery, ProteinByIdQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<ProteinByIdQuery, ProteinByIdQueryVariables>(
    ProteinByIdDocument,
    options,
  )
}
